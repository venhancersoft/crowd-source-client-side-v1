...
function Footer() {
    ...
    //                             <img src={logoWhite} width="180" className="m-b15" alt=""/>
    //                             <p className="text-capitalize m-b20">Lorem Ipsum is simply dummy text of the printing
    //                                 and typesetting industry has been the industry's standard dummy text ever since
    //                                 the.</p>
    //                             <div className="subscribe-form m-b20">
    //                                 <form className="dzSubscribe" action="script/mailchamp.php" method="post">
    //                                     <div className="dzSubscribeMsg"></div>
    //                                     <div className="input-group">
    //                                         <input name="dzEmail" required="required" className="form-control"
    ...
    //                                 <li><Link to={''} className="site-button white google-plus circle "><i
    //                                     className="fa fa-google-plus"></i></Link></li>
    //                                 <li><Link to={''} className="site-button white linkedin circle "><i
    //                                     className="fa fa-linkedin"></i></Link></li>
    //                                 <li><Link to={''} className="site-button white instagram circle "><i
    //                                     className="fa fa-instagram"></i></Link></li>
    //                                 <li><Link to={''} className="site-button white twitter circle "><i
