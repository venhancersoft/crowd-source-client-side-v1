                ...
                {latestBlog.map((item, index) => (
                    <div className="item p-3" key={index}>
                        <div className="blog-post blog-grid blog-style-1">
                            <div className="dez-post-media dez-img-effect radius-sm"><Link to={'/blog-details'}><img
                                src={item.image} alt=""/></Link></div>
                            <div className="dez-info">
                                <div className="dez-post-meta">
                                    <ul className="d-flex align-items-center">
                                        <li className="post-date"><i className="fa fa-calendar"></i>September 18, 2017
                                        </li>
                                ...
                                <div className="dez-post-title ">
                                    <h5 className="post-title font-20"><Link to={'/blog-details'}>Do you have a job that
                                        the average person doesn even know exists?</Link></h5>
                                </div>
