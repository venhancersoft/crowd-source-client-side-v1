            ...
            <div className="container">
                <div className="d-flex job-title-bx section-head">
                    ...
                    <div className="align-self-end">
                        <Link to={'/browse-job-list'} className="site-button button-sm">Browse All Jobs <i
                ...
                <div className="row">
                    <div className="col-lg-9">
                        ...
                        <div className="m-t30">
                            <div className="d-flex">
                                <Link className="site-button button-sm mr-auto" to={''}><i
                                    className="ti-arrow-left"></i> Prev</Link>
                        ...
                        <div className="sticky-top">
                            <div className="candidates-are-sys m-b30">
                                <div className="candidates-bx">
                                    <div className="testimonial-pic radius"><img src={pic3} alt="" width="100"
                                                                                 height="100"/></div>
                                    <div className="testimonial-text">
                                        <p>I just got a job that I applied for via careerfy! I used the site all the
                                            time during my job hunt.</p>
                                    </div>
                                    <div className="testimonial-detail"><strong className="testimonial-name">Richard
                                        Anderson</strong> <span className="testimonial-position">Nevada, USA</span>
                                    </div>
                                </div>
                            </div>
