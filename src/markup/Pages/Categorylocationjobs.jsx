                            ...
                            <div className="category-jobs-info">
                                <div className="nav">
                                    <ul>
                                        ...
                                        <li className="active"><Link to={'/category-location-jobs'}>Jobs by
                                            Location</Link></li>
                        ...
                        <div className="container">
                                ...
                                <div className="col-lg-12 m-b30 clearfix">
                                    <div className="job-bx bg-white">
                                        <div className="job-bx-title clearfix">
                                            <h6 className="font-weight-700 pull-left text-uppercase">Browse Jobs by Top
                                                Locations</h6>
                                        </div>
                                        <div className="row">
                            ...
                            <div id="masonry" className="row">
                                <div className="card-container clearfix col-lg-3 col-sm-6 m-b30">
                                    <div className="job-bx bg-white">
                                        <div className="job-bx-title clearfix">
                                            <h6 className="font-weight-700 pull-left m-b0 font-13 text-uppercase">Jobs
                                                In London</h6>
                                        </div>
                                        <ul className="category-list">
                                            <li><Link to={''}>Email Marketing</Link></li>
