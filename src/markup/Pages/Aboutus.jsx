                            ...
                            <div className="row align-items-center m-b50">
                                <div className="col-md-12 col-lg-6 m-b20">
                                    ...
                                    <p className="m-b15">Lorem Ipsum is simply dummy text of the printing and
                                        ...
                                        ever since the 1500s, when an unknown printer took a galley of type and. It is a
                                        ...
                                        has a more-or-less.</p>
                                    <p className="m-b15">It is a long established fact that a reader will be distracted
                                        by the readable content of a page when looking at its layout. The point of using
                                        Lorem Ipsum is that it has a more-or-less.</p>
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-4 col-sm-12 m-b30">
                                    <div className="icon-bx-wraper p-a30 center bg-gray radius-sm">
                                        <div className="icon-md text-primary m-b20"><Link to={'#'}
                                                                                          className="icon-cell text-primary"><i
                                            className="ti-desktop"></i></Link></div>
