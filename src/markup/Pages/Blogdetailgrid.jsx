                    ...
                    <div className="container">
                                            ...
                                            <div className="dez-post-meta">
                                                <ul className="d-flex align-items-center">
                                                    ...
                                                    <li className="post-comment"><i
                                                        className="fa fa-comments-o"></i><Link to={'#'}>5k</Link></li>
                                                </ul>
                                            </div>
                                            <div className="dez-post-title">
                                                <h5 className="post-title font-20"><Link to={'/blog-details'}>Do you
                                                    have a job that the average person doesn even know exists?</Link>
                                                </h5>
                                            </div>
                        ...
                        <div className="pagination-bx clearfix text-center">
                            <ul className="pagination">
                                <li className="previous"><Link to={'#'}><i className="ti-arrow-left"></i> Prev</Link>
                                </li>
