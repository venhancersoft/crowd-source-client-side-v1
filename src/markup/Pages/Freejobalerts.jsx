...
import bnr2 from '@/images/background/bg3.jpg';
                                ...
                                <div className="row">
                                                    ...
                                                    <div className="form-group">
                                                        <div className="custom-control custom-checkbox">
                                                            ...
                                                            <label className="custom-control-label"
                                                                   htmlFor="job-alert-check">Also send me jobs closely
                                                                related to my search terms </label>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="col-lg-4 bg-gray">
                                        <div className="p-a25">
                                            ...
                                            <p className="m-b10"><strong
                                                className="text-black m-r10">800,000+ </strong> Jobs</p>
                                            <p className="m-b10"><strong
                                                className="text-black m-r10">100,000+</strong> CV searches daily</p>
